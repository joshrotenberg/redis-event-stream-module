...
fn prune_call_options() -> CallOptions {
...
#[cfg(not(test))]
fn stream_liveness(ctx: &Context, name: &str) -> (i64, i64) {
...
#[cfg(not(test))]
fn streams_in_db0(ctx: &Context, registry: &str, mode: StreamsMode) -> RedisResult {
...
/// removed.
#[cfg(not(test))]
fn prune_in_db0(ctx: &Context, registry: &str) -> RedisResult {
...
#[cfg(not(test))]
fn cmd_prune(ctx: &Context, args: Vec<RedisString>) -> RedisResult {
    if args.len() != 1 {
